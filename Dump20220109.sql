...
INSERT INTO `user` VALUES (5,'John Travolta','$2a$10$eQHNN.KYuXTGPHgfAYB24eYY45UBv4wYfSvBfW0YTXc1jwJvFphpq','john'),(6,'Will Smith','$2a$10$FU9LGhBbS2YF7ttbCutjL.ZsUYQPSFDFpAl6evAd7epHUoEmzBAfO','will'),(7,'Jim Carry','$2a$10$EuE.rJza4RgBnfvVpuDw/.BQjo4V.B0uvZaRD/ypw53X3.5ZJQGx.','jim'),(8,'Arnold Schwarzenegger','$2a$10$acmI6bOBndZ2RVMbbRiEROElMVLeEHu5/.WZCLAuOAJgruKxHNL.2','arnold');
...
INSERT INTO `user_roles` VALUES (5,1),(5,2),(6,2),(7,3),(8,4),(8,3),(8,1);
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-09-11 22:43:28',NULL),('diagnostics.include_raw','OFF','2021-09-11 22:43:28',NULL),('ps_thread_trx_info.max_length','65535','2021-09-11 22:43:28',NULL),('statement_performance_analyzer.limit','100','2021-09-11 22:43:28',NULL),('statement_performance_analyzer.view',NULL,'2021-09-11 22:43:28',NULL),('statement_truncate_len','64','2021-09-11 22:43:28',NULL);
...
--
-- Current Database: `bootdb`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `bootdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `bootdb`;

--
-- Current Database: `margarita`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `margarita` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `margarita`;

--
-- Table structure for table `card_id_auto`
--

DROP TABLE IF EXISTS `card_id_auto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `card_id_auto` (
  `next_val` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `card_id_auto`
--

LOCK TABLES `card_id_auto` WRITE;
/*!40000 ALTER TABLE `card_id_auto` DISABLE KEYS */;
INSERT INTO `card_id_auto` VALUES (16);
/*!40000 ALTER TABLE `card_id_auto` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `item_id_auto`
--

DROP TABLE IF EXISTS `item_id_auto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `item_id_auto` (
  `next_val` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `item_id_auto`
--

LOCK TABLES `item_id_auto` WRITE;
/*!40000 ALTER TABLE `item_id_auto` DISABLE KEYS */;
INSERT INTO `item_id_auto` VALUES (101);
/*!40000 ALTER TABLE `item_id_auto` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oracle_db_auto_id`
--

DROP TABLE IF EXISTS `oracle_db_auto_id`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oracle_db_auto_id` (
  `next_val` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `oracle_db_auto_id`
--

LOCK TABLES `oracle_db_auto_id` WRITE;
/*!40000 ALTER TABLE `oracle_db_auto_id` DISABLE KEYS */;
INSERT INTO `oracle_db_auto_id` VALUES (1501);
/*!40000 ALTER TABLE `oracle_db_auto_id` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oracle_db_seq_id`
--

DROP TABLE IF EXISTS `oracle_db_seq_id`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oracle_db_seq_id` (
  `next_val` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `oracle_db_seq_id`
--

LOCK TABLES `oracle_db_seq_id` WRITE;
/*!40000 ALTER TABLE `oracle_db_seq_id` DISABLE KEYS */;
INSERT INTO `oracle_db_seq_id` VALUES (1551),(1);
/*!40000 ALTER TABLE `oracle_db_seq_id` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `FKcpl0mjoeqhxvgeeeq5piwpd3i` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order` VALUES (42,'2021-12-10',2038,802,'SHIPPED','5R64FV211D'),(43,'2021-12-20',213,802,'SHIPPED','TSBPACYXBD'),(44,'2021-12-20',31,802,'SHIPPED','C13QHGSGZ1'),(45,'2021-12-21',104,802,'SHIPPED','ZH8GLQ3Z08'),(46,'2021-12-21',53,802,'SHIPPED','J24HXNR5N5'),(47,'2021-12-23',13,802,'SHIPPED','NLZ01DF6WM'),(48,'2021-12-23',53,802,'SHIPPED','4WQNO4SA1T'),(49,'2021-12-24',75,802,'SHIPPED','ELIX0UOB7D'),(50,'2021-12-26',3059,802,'SHIPPED','HJBF26GWWO'),(51,'2021-12-29',237,803,'SHIPPED','12OCC03I6K'),(52,'2021-12-29',230,803,'SHIPPED','2I9GFIZMF3'),(53,'2021-12-29',132,803,'SHIPPED','D7944BL5CG'),(54,'2021-12-29',45,803,'SHIPPED','2XCBELX8K5'),(55,'2021-12-29',84,803,'SHIPPED','JZ9VW96B9U'),(56,'2021-12-29',53,803,'SHIPPED','YNMX78RH27'),(57,'2021-12-29',27,803,'SHIPPED','6ZXOH2D30I'),(58,'2021-12-29',53,803,'SHIPPED','4ZUPC0SN92'),(59,'2021-12-29',53,803,'SHIPPED','VMWFCIRTCG'),(60,'2021-12-29',27,803,'SHIPPED','6RH8JKPUWL'),(61,'2021-12-29',53,803,'NEW','AM9Y9TKOF1'),(62,'2021-12-29',13,803,'SHIPPED','U9PLN6AP67'),(63,'2021-12-29',53,803,'SHIPPED','G0Z4VFZ0FU'),(64,'2021-12-29',53,803,'NEW','IEV1DX1M0Y'),(65,'2021-12-29',5327,802,'SHIPPED','1UU5FZ8NU4'),(66,'2021-12-30',159,802,'SHIPPED','I7XA6ZR90V'),(67,'2021-12-30',23,802,'NEW','YCM1XJLBBK'),(68,'2021-12-30',13,802,'SHIPPED','L0CQHJ8SL5'),(69,'2022-01-01',21,802,'NEW','9NM3A8IGHK'),(70,'2022-01-01',260,802,'SHIPPED','2V0GN4AWKZ'),(71,'2022-01-01',212,802,'SHIPPED','3O1W3QJEGL'),(72,'2022-01-01',13,802,'SHIPPED','SNFEUVXQSS'),(73,'2022-01-01',530,802,'NEW','6B6HOPL7OU'),(74,'2022-01-01',256,802,'SHIPPED','CCNJCJ0D40'),(75,'2022-01-02',54,802,'NEW','5XUBUAFBGB'),(76,'2022-01-03',84,802,'NEW','8AIOG3PC21'),(77,'2022-01-03',168,802,'NEW','LAACQQF4T7'),(78,'2022-01-03',79,802,'NEW','WCNVIS1EV2'),(79,'2022-01-09',39,802,'NEW','GHOHL3EDCH'),(80,'2022-01-09',188,802,'NEW','02X9G2N3V5');
/*!40000 ALTER TABLE `order` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `order_id_auto`
--

DROP TABLE IF EXISTS `order_id_auto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `order_id_auto` (
  `next_val` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `order_id_auto`
--

LOCK TABLES `order_id_auto` WRITE;
/*!40000 ALTER TABLE `order_id_auto` DISABLE KEYS */;
INSERT INTO `order_id_auto` VALUES (81);
/*!40000 ALTER TABLE `order_id_auto` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `order_item` VALUES (7,246,52),(8,100,51),(9,50,51),(10,100,51),(11,50,52),(12,50,52),(13,50,52),(14,200,52),(15,12,50),(16,50,52),(17,100,52),(18,100,52),(19,50,52),(20,1,68),(21,1,69),(22,1,70),(23,1,67),(24,3,55),(25,1,68),(26,1,69),(27,1,62),(28,2,49),(29,1,61),(30,1,68),(31,1,55),(32,1,61),(33,1,55),(34,1,56),(35,2,68),(40,132,52),(42,100,55),(49,10,56),(50,1,66),(51,2,55),(52,4,62),(53,2,55),(54,2,61),(55,1,49),(56,1,61),(57,1,55),(58,1,62),(59,1,55),(60,1,67),(61,1,55),(62,1,55),(63,1,68),(64,1,55),(65,1,61),(66,1,55),(67,1,55),(68,1,73),(69,1,59),(70,1,57),(71,1,58),(72,1,52),(73,1,66),(74,1,71),(75,1,58),(76,1,61),(77,1,56),(78,20,61),(79,4,55),(80,1,61),(81,10,55),(87,8,49),(88,2,68),(89,4,56),(90,2,55),(91,2,62),(92,1,60),(93,2,61),(94,1,54),(96,3,61),(97,2,50),(98,1,67),(99,1,62),(100,1,61);
...
CREATE TABLE `order_items` (
  ...
  KEY `FKjg8ob3r0ws22krbj2xu30nhi1` (`order_id`),
  KEY `FKrd80tjr9b30mc1clst1tdyhq7` (`order_item_id`),
  CONSTRAINT `FKjg8ob3r0ws22krbj2xu30nhi1` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`) ON DELETE CASCADE,
  CONSTRAINT `FKrd80tjr9b30mc1clst1tdyhq7` FOREIGN KEY (`order_item_id`) REFERENCES `order_item` (`item_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_items` VALUES (42,15),(42,16),(42,20),(42,21),(42,22),(42,23),(43,24),(43,25),(43,26),(44,27),(45,28),(45,29),(45,30),(46,31),(47,32),(48,33),(49,34),(49,35),(50,40),(51,49),(51,50),(52,51),(52,52),(53,53),(53,54),(54,55),(54,56),(55,57),(55,58),(56,59),(57,60),(58,61),(59,62),(60,63),(61,64),(62,65),(63,66),(64,67),(65,42),(65,68),(66,69),(66,70),(66,71),(66,72),(66,73),(66,74),(67,75),(68,76),(69,77),(70,78),(71,79),(72,80),(73,81),(74,87),(75,88),(76,89),(77,90),(77,91),(78,92),(78,93),(78,94),(79,96),(80,97),(80,98),(80,99);
...
INSERT INTO `product` VALUES (48,'BASIC','Saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze.','CHOCOLATE CHEESE CAKE',27,'http://localhost:8080/download/48.jpg'),(49,'BASIC','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze.','CHOCOLATE CHEESE CAKE',32,'http://localhost:8080/download/49.jpg'),(50,'BASIC','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze.','CHOCOLATE CHEESE CAKE',65,'http://localhost:8080/download/50.jpg'),(51,'BASIC','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze.','CHOCOLATE CHEESE CAKE',34,'http://localhost:8080/download/51.jpg'),(52,'BASIC','Saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze.','CHOCOLATE CHEESE CAKE',23,'http://localhost:8080/download/52.jpg'),(53,'BASIC','Saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze.','CHOCOLATE CHEESE CAKE',15,'http://localhost:8080/download/53.jpg'),(54,'BIRTHDAY','Saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze.','CHOCOLATE CHEESE CAKE',32,'http://localhost:8080/download/54.jpg'),(55,'BIRTHDAY','Saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze.','CHOCOLATE CHEESE CAKE',53,'http://localhost:8080/download/55.jpg'),(56,'BIRTHDAY','Saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze.','CHOCOLATE CHEESE CAKE',21,'http://localhost:8080/download/56.jpg'),(57,'BIRTHDAY','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze','CHOCOLATE CHEESE CAKE',14,'http://localhost:8080/download/57.jpg'),(58,'BIRTHDAY','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze','CHOCOLATE CHEESE CAKE',23,'http://localhost:8080/download/58.jpg'),(59,'BIRTHDAY','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze','CHOCOLATE CHEESE CAKE',45,'http://localhost:8080/download/59.jpg'),(60,'SPECIAL','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze','CHOCOLATE CHEESE CAKE',21,'http://localhost:8080/download/60.jpg'),(61,'SPECIAL','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze','CHOCOLATE CHEESE CAKE',13,'http://localhost:8080/download/61.jpg'),(62,'SPECIAL','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze','CHOCOLATE CHEESE CAKE',31,'http://localhost:8080/download/62.jpg'),(63,'SPECIAL','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze','CHOCOLATE CHEESE CAKE',54,'http://localhost:8080/download/63.jpg'),(64,'SPECIAL','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze','CHOCOLATE CHEESE CAKE',31,'http://localhost:8080/download/64.jpg'),(65,'SPECIAL','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze','CHOCOLATE CHEESE CAKE',43,'http://localhost:8080/download/65.jpg'),(66,'SPECIAL','Lorem Lorem Lorem Lorem','Margarita',27,'http://localhost:8080/download/66.jpg'),(67,'WEDDING','Lorem Lorem Lorem Lorem','Margarita',27,'http://localhost:8080/download/67.jpg'),(68,'WEDDING','Lorem Lorem Lorem Lorem','Margarita',27,'http://localhost:8080/download/68.jpg'),(69,'WEDDING','Lorem Lorem Lorem Lorem','Margarita',27,'http://localhost:8080/download/69.jpg'),(70,'WEDDING','Lorem Lorem Lorem Lorem','Margarita',27,'http://localhost:8080/download/70.jpg'),(71,'WEDDING','Lorem Lorem Lorem Lorem','Margarita',27,'http://localhost:8080/download/71.jpg'),(72,'WEDDING','Lorem Lorem Lorem Lorem','Margarita',27,'http://localhost:8080/download/72.jpg'),(73,'BASIC','saturated chocolate cake, eclairs with baileys cream, banana, chocolate glaze','CHOCOLATE CAKE',27,'http://localhost:8080/download/73.jpg');
...
INSERT INTO `shopping_card` VALUES (1),(2),(7),(8),(9),(10),(11),(12),(13),(14),(15);
...
CREATE TABLE `shopping_card_item` (
  ...
  KEY `FKb5q2lmsfbsh6tdrarf7i0vcso` (`card_item_id`),
  KEY `FKjvlqrtwheeww6hv5p8c7omxyi` (`card_id`),
  CONSTRAINT `FKb5q2lmsfbsh6tdrarf7i0vcso` FOREIGN KEY (`card_item_id`) REFERENCES `order_item` (`item_id`),
  CONSTRAINT `FKjvlqrtwheeww6hv5p8c7omxyi` FOREIGN KEY (`card_id`) REFERENCES `shopping_card` (`card_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shopping_card_item` VALUES (7,100);
...
CREATE TABLE `user` (
  ...
  KEY `FKtl0jycn6g8bu3j6b5mrqemngp` (`user_card_id`),
  CONSTRAINT `FKtl0jycn6g8bu3j6b5mrqemngp` FOREIGN KEY (`user_card_id`) REFERENCES `shopping_card` (`card_id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `user` WRITE;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` VALUES (802,'admin','$2a$10$g3j0l7omxFvUrAKP5X/XDeDBRF2x5ShaOQB0QSq/mqvcERz4kk4fS','admin','Varna','Bulgaria','stoycho___@abv.bg','000000','mortierlaan','da','9000',7),(803,'User User','$2a$10$i4.A4jlw6w61KpA/.kIba.ZQ5jxQ.MOGmfpZnqW9809nrdEdFw2G2','user','city','country','email','phone','street','streetNumber','zipCode',1),(852,'Employee Employee','$2a$10$sZ/SQybNwdFJmIhBrAenPedkT6rYgJYvppoMoRoH8C54H0cTE4lxW','employee','city','country','email','phone','street','streetNumber','zipCode',2),(1354,'aaaaa','$2a$10$7o4ExAA4Zt41B9E8S/wvhuZVAv45vYiFY6q2Jk///DXMPf/UowDVu','TEST','','','TEST@abv.gb','','','','',8),(1402,'aaaaaa','$2a$10$KQtzSgEaCg93NhvW2CPg4.uh6zpgVeFiZaJdOzzLDrBvdqDGw37jy','TEST12','aaaaaaaaa','aaaaaaaa','stojcho___@abv.bg','aaaaaa','aaaaaaaa','aaaaaaaaa','aaaaa',9),(1403,NULL,'$2a$10$3I.JteVbq8ehBxeemgoX5eqX8G0BnGyhSpQ1s.eBcj.SUqcJjY4WC','TEST12123',NULL,NULL,'ani_style75@abv.bg',NULL,NULL,NULL,NULL,10),(1404,NULL,'$2a$10$e9R9XZ4I5noWxbRgk6mZyelMre.GIR8Dgfi2XDZuQYiDw7DDOApu.','TEST12sda',NULL,NULL,'stojcho___@abv.bg',NULL,NULL,NULL,NULL,11),(1405,NULL,'$2a$10$KDodys0.Aj3vYhmeDjb2I.wCrmZH89Ie7kFGC0pKbflwVXPU/Z6RO','TESTdasdasdfs',NULL,NULL,'stojcho___@abv.bg',NULL,NULL,NULL,NULL,12),(1406,NULL,'$2a$10$xkb5B11ZtMa12vjXULY4leolLevgy3Mp7OEs0tJpmQhbWzbJ/dMDu','TEST124rr',NULL,NULL,'stojcho___@abv.bg',NULL,NULL,NULL,NULL,13),(1407,NULL,'$2a$10$46jzInjO/DatfJ2/hrTiJuFr92ds.aIWTH2vJaEsrsajozaC9iQyS','TEST122',NULL,NULL,'stojcho___@abv.bg',NULL,NULL,NULL,NULL,14),(1408,NULL,'$2a$10$Yvb9CkNCGztQKPa5ev2gJOQ56E6ketEi4jDMoCE4GyHN21gb3dpiC','TEST12321',NULL,NULL,'stoycho___@abv.bg',NULL,NULL,NULL,NULL,15);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_roles` (
  ...
  KEY `RoleFK` (`roles_id`),
  KEY `UserFK` (`user_id`),
  KEY `UserRoleFK_idx` (`user_id`,`roles_id`),
  CONSTRAINT `RoleFK` FOREIGN KEY (`roles_id`) REFERENCES `role` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
LOCK TABLES `user_roles` WRITE;
/*!40000 ALTER TABLE `user_roles` DISABLE KEYS */;
INSERT INTO `user_roles` VALUES (802,1),(802,3),(803,1),(852,2),(1354,1),(1402,1),(1403,1),(1404,1),(1405,1),(1406,1),(1407,1),(1408,1);
/*!40000 ALTER TABLE `user_roles` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-09 14:40:01
